...
public class ParamterCoverage {
    ...
    public ParamterCoverage(List<String[]> scenariosList){
        //define buckets for all variables
        String input = JOptionPane.showInputDialog(null, "Enter step size for Continuous variables in decimal",
                "Step Size Input", JOptionPane.QUESTION_MESSAGE);
        String inputDiscrete = JOptionPane.showInputDialog(null, "Enter step size for discreate variables in number ",
                "Step Size Input", JOptionPane.QUESTION_MESSAGE);
        double stepSize;
