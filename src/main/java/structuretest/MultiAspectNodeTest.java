...
public class MultiAspectNodeTest {
    ...
    public void parseNodes(String xmlFilePath) {
        try {
            ...
            System.out.println("Multi aspect node found in main graph xml file  ..................................");
    ...
    public void checkCodeCoverageMultiAspect(List<String[]> scenariosList) {
        ...
        if (ssdFileLimit.exists()) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Please set the limit for each MultiAspect node to calculate coverage.",
                    "Error",
...
//        double parentNodeCoveragePercentage = (totalNodes > 0) ? (double) coveredNodes / totalNodes * 100 : 0;    // Getter methods to access global totals
